        ...
        <div className="flex flex-col md:flex-row gap-4 relative z-10 w-full xl:w-auto shrink-0 items-end">
          <div className="space-y-1">
            ...
            <select
              ...
              className="bg-white border border-slate-200 text-slate-700 rounded-xl px-3 py-2.5 text-sm font-bold outline-none focus:ring-2 focus:ring-emerald-500 shadow-sm cursor-pointer h-[42px]"
            >
          ...
          {uniqueSubIndicators.length > 0 && (
            <div className="space-y-1">
              <label className="text-cyan-700 text-[11px] uppercase tracking-wider font-bold ml-1">
