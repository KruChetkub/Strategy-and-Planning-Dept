...
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-white/95 border border-slate-200 p-3 rounded-xl backdrop-blur-md shadow-lg text-base">
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-slate-800 font-medium">
          กำลังโหลดข้อมูล Health KPI รายเขตฯ...
        </p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-rose-500 gap-4">
        ...
        <p className="text-base opacity-80">{error.message}</p>
      </div>
    );
  }
    ...
    <div className="max-w-[1700px] w-full mx-auto space-y-6 pb-10">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 relative z-20 shadow-md overflow-hidden flex flex-col xl:flex-row justify-between xl:items-center gap-6">
        ...
        <div className="flex-1 max-w-2xl">
          <h1 className="text-3xl lg:text-4xl font-black text-slate-800 tracking-tight break-words flex items-center gap-3 mb-2">
        ...
        <div className="flex flex-col md:flex-row gap-4 relative z-10 w-full xl:w-auto shrink-0 items-center">
          <div className="space-y-1">
            <label className="text-emerald-700 text-[15px] uppercase tracking-wider font-bold ml-1">
              เลือกตัวชี้วัดหลัก
            </label>
            <select
              value={selectedMain}
              onChange={(e) => setSelectedMain(e.target.value)}
              className="w-full xl:w-[350px] bg-white border border-slate-300 text-emerald-800 font-bold px-4 py-2.5 rounded-xl outline-none focus:border-emerald-500 transition-colors cursor-pointer text-base shadow-sm truncate"
            >
          ...
          {uniqueSubIndicators.length > 0 && (
            <div className="space-y-1">
              <label className="text-cyan-700 text-[14px] uppercase tracking-wider font-bold ml-1">
                เลือกตัวชี้วัดย่อย (ถ้ามี)
              </label>
              <select
                value={selectedSub}
                onChange={(e) => setSelectedSub(e.target.value)}
                className="w-full xl:w-[250px] bg-white border border-slate-300 text-cyan-800 font-bold px-4 py-2.5 rounded-xl outline-none focus:border-cyan-500 transition-colors cursor-pointer text-base shadow-sm truncate"
              >
        ...
        <div className="flex flex-col gap-6 animate-in fade-in zoom-in duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-cyan-100 rounded-3xl p-6 shadow-sm flex items-center justify-between relative overflow-hidden group">
              ...
              <div className="z-10">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <p className="text-base font-bold text-cyan-700 tracking-wide bg-cyan-100 px-2 py-0.5 rounded-md">
            ...
            <div className="bg-white border border-purple-100 rounded-3xl p-6 shadow-sm flex items-center justify-between relative overflow-hidden group">
              ...
              <div className="z-10">
                ...
                <p className="text-3xl font-black text-slate-800 truncate max-w-[200px]">
                  {categoryStats.regData.length > 0
                    ? [...categoryStats.regData].sort(
                        (a, b) => b.avg - a.avg,
                      )[0].name
                    : "-"}
                </p>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis
                        ...
                        domain={[
                          (dataMin) =>
                            Math.min(0, Math.floor(dataMin / 20) * 20),
                          (dataMax) =>
                            Math.max(100, Math.ceil(dataMax / 20) * 20),
                        ]}
                      />
                      <Tooltip
                        cursor={{ fill: "#f1f5f9" }}
            ...
            <div className="xl:col-span-3 bg-white border border-slate-200 rounded-3xl p-6 shadow-md flex flex-col items-center justify-center h-full">
              <h3 className="text-base font-bold text-slate-800 flex items-center gap-2 mb-2 self-start w-full">
              ...
              <div className="h-[180px] w-full relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  ...
                  <p className="text-[0.79rem] text-slate-800 font-bold uppercase tracking-widest mt-1">
                    Total KPIs
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-md overflow-hidden flex flex-col">
            ...
            <div className="overflow-x-auto custom-scrollbar pb-4 flex-1">
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="border-b border-slate-200 text-slate-800 text-sm uppercase tracking-wider bg-slate-50">
                    ...
                    .map((kpi, idx) => (
                      ...
                      >
                        <td className="p-4 text-center">
                          <span className="inline-flex w-7 h-7 rounded-lg bg-rose-50 border border-rose-100 text-rose-500 text-base font-black shadow-inner items-center justify-center">
                            {idx + 1}
                          </span>
                        </td>
                        <td
                        ...
                        <td className="p-4 text-center">
                          <div className="flex items-center justify-center gap-2 bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200 w-max mx-auto">
                            ...
                            <span className="text-slate-800 text-sm mt-0.5">
                              /
                            </span>
                        ...
                        <td className="p-4 text-center bg-slate-50 font-black text-rose-500 text-xl rounded-md">
                          {kpi.avgPerf}
                        </td>
                        <td className="p-4 text-center">
                          <div
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
            ...
            <div className="xl:col-span-4 space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-1.5 shadow-md relative overflow-hidden group">
                <h3 className="absolute top-4 left-5 z-20 text-base font-bold text-slate-800 flex items-center gap-2 bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-md relative overflow-hidden">
                ...
                <div className="flex flex-col items-center justify-center text-center mb-8 relative z-10">
                  <p className="text-slate-800 font-bold mb-1 uppercase tracking-widest text-sm">
                    ผลงานเฉลี่ยรวมระดับประเทศ
                  </p>
                  <div className="flex items-end justify-center gap-1">
                    <p className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-cyan-500 drop-shadow-sm">
                      {summary.avgPerf}
                    </p>
                ...
                <div>
                  <p className="text-slate-800 font-bold mb-3 flex items-center gap-2 text-base">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    ...
                    >
                      <p
                        className={`text-[11px] font-bold mb-1 ${currentQ.id === "Q1" ? "text-emerald-600" : "text-slate-800"}`}
                      >
                        ไตรมาส 1
                      </p>
                      <p
                        className={`text-base font-bold ${currentQ.id === "Q1" ? "text-slate-800" : "text-slate-600"}`}
                      >
                        {allTargets.q1}
                      </p>
                    </div>
                    ...
                    >
                      <p
                        className={`text-[11px] font-bold mb-1 ${currentQ.id === "Q2" ? "text-emerald-600" : "text-slate-800"}`}
                      >
                        ไตรมาส 2
                      </p>
                      <p
                        className={`text-base font-bold ${currentQ.id === "Q2" ? "text-slate-800" : "text-slate-600"}`}
                      >
                        {allTargets.q2}
                      </p>
                    </div>
                    ...
                    >
                      <p
                        className={`text-[11px] font-bold mb-1 ${currentQ.id === "Q3" ? "text-emerald-600" : "text-slate-800"}`}
                      >
                        ไตรมาส 3
                      </p>
                      <p
                        className={`text-base font-bold ${currentQ.id === "Q3" ? "text-slate-800" : "text-slate-600"}`}
                      >
                        {allTargets.q3}
                      </p>
                    </div>
                    ...
                    >
                      <p
                        className={`text-[11px] font-bold mb-1 ${currentQ.id === "Q4" ? "text-emerald-600" : "text-slate-800"}`}
                      >
                        ไตรมาส 4
                      </p>
                      <p
                        className={`text-base font-bold ${currentQ.id === "Q4" ? "text-slate-800" : "text-slate-600"}`}
                      >
                        {allTargets.q4}
                      </p>
                    </div>
                ...
                <div className="bg-white border border-emerald-100 rounded-3xl p-6 shadow-sm flex items-center justify-between relative overflow-hidden group">
                  ...
                  <div className="z-10">
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <p className="text-base font-bold text-emerald-700 tracking-wide bg-emerald-100 px-2 py-0.5 rounded-md">
                ...
                <div className="bg-white border border-rose-100 rounded-3xl p-6 shadow-sm flex items-center justify-between relative overflow-hidden group">
                  ...
                  <div className="z-10">
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <p className="text-base font-bold text-rose-600 tracking-wide bg-rose-100 px-2 py-0.5 rounded-md">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mt-2">
                ...
                <table className="w-full text-left border-collapse min-w-[1000px]">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {dashboardData.map((kpi) => (
                      ...
                      >
                        <td className="p-4">
                          <span className="inline-block px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-slate-600 text-sm font-bold tracking-wider whitespace-nowrap">
                            {kpi.region}
                          </span>
                        </td>
                        <td className="p-4 text-blue-700 font-bold text-center bg-blue-50">
                          {kpi.pop_35
                            ? Number(kpi.pop_35).toLocaleString()
                            : "-"}
                        </td>
                        <td className="p-4 text-teal-700 font-bold text-center bg-teal-50">
                          {kpi.pop_b ? Number(kpi.pop_b).toLocaleString() : "-"}
                        </td>
                        <td className="p-4 text-center bg-slate-50 font-black text-slate-800 text-xl rounded-md">
                        ...
                        <td className="p-4 text-center">
                          ...
                          >
                            ...
                            ></span>
                            <span
                              className={`text-sm font-bold ${kpi.status_info.color}`}
                            >
            ...
            <div className="xl:col-span-4 bg-white border border-slate-200 rounded-3xl p-6 shadow-md h-full max-h-[600px] overflow-y-auto custom-scrollbar">
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2 mb-6 border-b border-slate-200 pb-4 sticky top-0 bg-white/95 py-2 backdrop-blur-xl z-10">
                <Target size={18} className="text-blue-500" /> KPI Template
              </h3>
              <div className="space-y-6">
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 shadow-inner">
                  <p className="text-sm font-bold text-slate-800 mb-2 uppercase tracking-wider">
                    สูตรคำนวณที่ใช้
                  </p>
                  <p className="text-2xl font-mono text-center text-blue-600 font-black bg-white py-3 rounded-lg border border-blue-100 shadow-sm">
                    ( A / B ) × 100
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-50 p-4 rounded-xl border-l-4 border-blue-500">
                    <div className="flex gap-3 items-center mb-2">
                      <span className="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center font-black text-xl shadow-sm">
                        A
                      </span>
                    ...
                    <p className="text-base text-slate-800 leading-relaxed pl-11">
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border-l-4 border-teal-500">
                    <div className="flex gap-3 items-center mb-2">
                      <span className="w-8 h-8 rounded-lg bg-teal-100 text-teal-600 flex items-center justify-center font-black text-xl shadow-sm">
                        B
                      </span>
                      <p className="font-bold text-slate-800 text-base">
