...
export default function Dashboard({ categoryFilter }) {
  ...
  const { passed, pieData, barData } = useMemo(() => {
    ...
    const pieData = [
      ...
      {
        name: "ต่ำกว่าเป้า (99-75%)",
        value: totals.failed_75,
        color: "#facc15",
      },
      {
        name: "ระดับเสี่ยง (74-50%)",
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col h-full items-center justify-center space-y-4">
        ...
        <p className="text-cyan-400 animate-pulse tracking-widest text-lg">
  ...
  const glassHeaderClasses =
    "text-3xl font-bold text-slate-800 mb-6 flex items-center justify-between";
      ...
      <div className="space-y-8 max-w-7xl mx-auto pb-12">
        <div className="flex items-center justify-between mb-8 px-2">
          <div>
            ...
            <p className="text-sky-600 font-semibold text-lg mt-2 flex items-center gap-2">
        ...
        >
          <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mb-6 border border-slate-100 shadow-inner">
            <AlertTriangle className="text-slate-800" size={36} />
          </div>
          <h2 className="text-4xl font-bold text-slate-700 mb-2">
            ยังไม่มีข้อมูลในหมวดหมู่นี้
          </h2>
          <p className="text-slate-800 max-w-md mx-auto leading-relaxed">
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          <div className="absolute top-4 left-6 text-lg font-bold text-slate-800 uppercase tracking-widest">
            ความสำเร็จโดยรวม
          </div>
          ...
          <div className="relative w-48 h-48 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-base font-extrabold text-sky-600 uppercase tracking-[0.2em] mt-2">
                Completed
              </span>
            </div>
          </div>

          <p className="text-slate-800 font-bold text-lg mt-6 text-center max-w-[200px]">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-white border border-emerald-100 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all flex items-center gap-5 relative overflow-hidden group">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-emerald-600 uppercase tracking-widest mt-1">
                บรรลุเป้าหมาย
              </p>
          ...
          <div className="bg-white border border-yellow-100 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all flex items-center gap-5 relative overflow-hidden group">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-yellow-600 uppercase tracking-widest mt-1">
                ต่ำกว่าเป้าหมาย
              </p>
              <p className="text-base text-slate-800 font-medium mt-1">
          ...
          <div className="bg-white border border-orange-100 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all flex items-center gap-5 relative overflow-hidden group">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-orange-600 uppercase tracking-widest mt-1">
                ระดับเสี่ยง
              </p>
              <p className="text-base text-slate-800 font-medium mt-1">
          ...
          <div className="bg-white border border-rose-100 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all flex items-center gap-5 relative overflow-hidden group">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-rose-600 uppercase tracking-widest mt-1">
                ขั้นวิกฤติ
              </p>
              <p className="text-base text-slate-800 font-medium mt-1">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100">
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider w-1/3">
                    No. / หมวดหมู่ / ตัวชี้วัด
                  </th>
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider text-right">
                    เป้าหมาย (2573)
                  </th>
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider text-right">
                    ผลงาน
                  </th>
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider w-40 text-center">
                    สถานะ
                  </th>
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider w-48 text-center">
                    หน่วยงาน
                  </th>
                  <th className="py-4 px-6 text-slate-800 font-bold text-base uppercase tracking-wider">
                    หมายเหตุ
                  </th>
                </tr>
              </thead>
                  ...
                  <React.Fragment key={groupIndex}>
                    ...
                    <tr className="bg-sky-50 border-b border-sky-100">
                      <td colSpan="6" className="p-0">
                        <div className="py-3 px-6 text-lg font-black text-sky-800 border-l-4 border-sky-500 shadow-sm sticky left-0 z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                          <span className="leading-relaxed">{groupCode}</span>
                          <span className="text-base font-bold text-sky-600 bg-white px-3 py-1 rounded-full border border-sky-200 shadow-sm whitespace-nowrap">
                      ...
                      >
                        <td className="py-5 px-6 align-top">
                          <div className="flex gap-4 items-start">
                            <span className="text-slate-800 font-black text-lg mt-0.5 w-7 shrink-0 border border-slate-200 rounded-md text-center py-1 bg-white group-hover:bg-slate-50 group-hover:border-slate-300 transition-colors shadow-sm">
                              {index + 1}
                            </span>
                            <div>
                              ...
                              <p
                                className="text-xl font-bold text-slate-800 leading-relaxed max-w-xl"
                                title={kpi.title}
                              >
                                {kpi.title}
                              </p>
                        ...
                        <td className="py-4 px-6 align-top text-right">
                          <span
                            className={`font-black text-3xl ${kpi.current_value !== null && kpi.current_value !== undefined && kpi.current_value !== "" ? "text-sky-600" : "text-slate-600"}`}
                          >
                        ...
                        <td className="py-4 px-6 align-top text-center text-base font-medium text-slate-800">
                          {kpi.agency || "-"}
                        </td>

                        <td className="py-5 px-6 align-top">
                          <div className="text-base text-slate-800 italic max-w-xs break-words bg-slate-50/50 p-2 rounded-lg border border-transparent group-hover:border-slate-100 transition-all">
                            {kpi.note || "-"}
                          </div>
                        </td>
                      </tr>
